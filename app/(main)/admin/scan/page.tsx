...
export default function Page() {
  return (
    <main className='flex h-full w-full flex-1 flex-col gap-2 overflow-y-scroll rounded-tl-2xl border border-neutral-200 bg-white p-4 max-sm:max-h-[calc(100vh-3rem)] md:p-10'>
      <OfflineAlert />
