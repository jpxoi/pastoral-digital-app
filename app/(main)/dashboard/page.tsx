...
export default function PastoralDigitalPage() {
  return (
    <main className='flex h-full w-full flex-1 flex-col gap-2 rounded-tl-2xl border border-neutral-200 bg-white p-4 md:p-10'>
      ...
      <div className='flex w-full flex-col items-center justify-start overflow-y-scroll max-sm:max-h-[calc(100vh-3rem)] lg:flex-row lg:items-start lg:justify-evenly'>
        <PastoralId />
