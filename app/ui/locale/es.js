export default {
  ...
  "files-count-limit-error-too-few":
    "Has seleccionado {{total}} {{plural:file(total)}}. Se requiere al menos {{min}} {{plural:file(min)}}.",
  "files-count-limit-error-too-many":
    "Has seleccionado demasiados archivos. {{max}} {{plural:file(max)}} es el máximo.",
  "files-max-size-limit-error":
    "El archivo es demasiado grande. El tamaño máximo de archivo es {{maxFileSize}}.",
  ...
  "file-type-not-allowed":
    "No se permite la subida de estos tipos de archivos.",
